...
<template>
  <header>
    ...
    <div class="input">
      ...
      >
      <button class="botao-busca" onclick="clicaNoBotao()">
        <img
          class="img-busca"
          alt="buscar"
    ...
    <nav class="nav">
      <a href="../paginas/nav.html" target="_blank">Sobre o app</a>
      <span> | </span>
...
.home-demo #item9 {
    background-image: url("imagens/imagem9.jpg");
    background-position: center;
    background-size: cover;
}
.home-demo #item10 {
...
.home-demo .item .texto:hover, .home-demo .item .texto:focus-within {
...
main div.principal .media-box .info {
    display: flex;
    flex-direction: column;
    justify-content: space-around;
    padding: 2rem 0;
...
main div.principal .media-box .info.clima {
    flex-direction: column;
    justify-content: space-around;
    align-items: center;
